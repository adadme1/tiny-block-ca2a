...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/tiny-block-ca2a)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/tiny-block-ca2a
```

A live public deployment of this template is available at [https://tiny-block-ca2a.templates.workers.dev](https://tiny-block-ca2a.templates.workers.dev)
